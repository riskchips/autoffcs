          ...
          {timetables.length > 0 ? (
            <>
              ...
              <div className="timetable-wrapper">
                <div id="capture-area" style={{ position: 'relative', width: 'max-content', padding: '1rem', background: isDarkMode ? '#222' : '#fff' }}>
                ...
                <div style={{ textAlign: 'center', marginTop: '1rem', opacity: 0.6, fontWeight: 900, fontSize: '1.2rem', letterSpacing: '4px', textTransform: 'uppercase' }}>
                  GENERATED BY AUTOFFCS.ARNABDEV.SPACE
                </div>
              </div>
            </div>
            </>
